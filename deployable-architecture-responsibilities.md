...
| Issues with {{site.data.keyword.IBM_notm}}-provided container, VSI, and Bare Metal images | {{site.data.keyword.IBM_notm}} provides a way for customers to open issues. | Customer provides information to reproduce any problem. |
